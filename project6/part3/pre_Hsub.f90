...
call exhar(nrad,rrad,urad,VH,vca)
contains
!*************************************************************************
subroutine exhar(nrad,rrad,urad,VH,vca)
implicit none
integer :: nrad,i
real(8) :: rrad(0:nrad), rho(0:nrad),a(0:nrad),b(0:nrad)
real(8) :: urad(0:nrad),v1(0:nrad),v2(0:nrad),VH(0:nrad),w(0:nrad)
real(8) :: vca,vcb,pi,EH,EC,EXC,EXCtrap,eta
!*************************************************************************
pi = 4*atan(1.d0)
a=0.d0; b=0.d0
VH=0.d0; rho=0.d0
